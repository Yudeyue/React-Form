...
namespace ThermostaEventsApp
{
    ...
    public class Thermostat : IThermostat
    {
        ...
        private void WireUpEventsToEventHandlers()
        {
            ...
            _heatSensor.TempertatureFailsBelowWarningLevelEventHanlder += _heatSensor_TempertatureFailsBelowWarningLevelEventHanlder;
        }

        private void _heatSensor_TempertatureFailsBelowWarningLevelEventHanlder(object? sender, TemperatureEventArgs e)
        {
    ...
    public class HeatSensor : IHeatSensor
    {
        ...
        static readonly object _tempertatureFailsBelowWarningLevelKey = new object();
        ...
        {
            EventHandler<TemperatureEventArgs> handler = (EventHandler<TemperatureEventArgs>)_listEventDelegates[_tempertatureFailsBelowWarningLevelKey];
        ...
        event EventHandler<TemperatureEventArgs> IHeatSensor.TempertatureFailsBelowWarningLevelEventHanlder
        {
            add
            {
                _listEventDelegates.AddHandler(_tempertatureFailsBelowWarningLevelKey, value);
            }

            remove
            {
                _listEventDelegates.RemoveHandler(_tempertatureFailsBelowWarningLevelKey, value);
            }
        }
    ...
    public interface IHeatSensor
    {
        ...
        event EventHandler<TemperatureEventArgs> TempertatureFailsBelowWarningLevelEventHanlder;
